                ...
                <div class="col-lg-6 mb-5 mb-lg-0 text-center text-lg-start">
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-lg-start gap-3 mb-3">
                        ...
                        <img
                            ...
                            style="height: 55px; width: auto; filter: drop-shadow(0 2px 8px rgba(0,0,0,0.6));"
                        >
                    ...
                    <p class="hero-subtitle mb-5 mx-auto mx-lg-0">
                        Sistem Pelaporan Sampah Terpadu wilayah Magetan, Jawa Timur.
                        Mari bersama wujudkan lingkungan bersih dengan melaporkan
                        tumpukan sampah atau pembuangan ilegal secara cepat dan mudah.
                    </p>
        ...
        <div class="row g-4 text-center justify-content-center mb-5">
            ...
            <div class="col-md-4">
                ...
                <div class="card border-0 h-100 banner-card p-4">
                    ...
                    <p class="text-muted">
                        Ambil foto tumpukan sampah atau pelanggaran kebersihan
                        yang Anda temui di lokasi.
                    </p>
            ...
            <div class="col-md-4">
                ...
                <div class="card border-0 h-100 banner-card p-4">
                    ...
                    <p class="text-muted">
                        Isi detail lokasi dan deskripsi singkat agar petugas
                        kami mudah menemukan titik tersebut.
                    </p>
            ...
            <div class="col-md-4">
                ...
                <div class="card border-0 h-100 banner-card p-4">
                    ...
                    <p class="text-muted">
                        Laporan diteruskan ke petugas kebersihan DLH Magetan
    ...
    <div class="py-5">
        ...
        <div class="container mb-4">
            ...
            <div class="text-center mb-5">
                ...
                <p class="text-muted mt-3">
                    Mengenal jenis-jenis sampah adalah langkah awal menuju
            ...
            <div class="card banner-card mb-5">
                ...
                <div class="card-body bg-white text-center p-4">
                    ...
                    >
                        ...
                        dengan mengenali dan melaporkan berbagai jenis sampah.
                        Pemilahan yang benar antara Sampah Rumah Tangga,
                        Pembuangan Liar, Sampah Saluran Air, Sampah Pasar,
                        hingga Limbah B3 Ringan akan sangat membantu proses
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="card border-0 shadow-sm h-100 banner-card">
                            ...
                            <div class="card-body p-4 d-flex flex-column">
                                ...
                                <img
                                    src="{{ $berita->thumbnail ? Storage::url($berita->thumbnail) : asset('images/no-image.png') }}"
