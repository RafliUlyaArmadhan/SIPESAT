            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0 text-center text-lg-start">
                    ...
                    <p class="hero-subtitle mb-5 mx-auto mx-lg-0">
                        ...
                        Sistem Pelaporan Sampah Terpadu wilayah
                        Magetan, Jawa Timur.

                        Mari bersama wujudkan lingkungan bersih
                        dengan melaporkan tumpukan sampah atau
                        pembuangan ilegal secara cepat dan mudah.
    ...
    <div class="container my-5 pt-4">
        ...
        <div class="row g-4 text-center justify-content-center mb-5">
            ...
            <div class="col-md-4">
                ...
                <div
                    class="card border-0 h-100 banner-card p-4">
                    ...
                    <div class="mb-3">
                        ...
                        >
                            ...
                            <i
                                class="fa-solid fa-camera fa-2x">
                            </i>
                    ...
                    <p class="text-muted">
                        ...
                        Ambil foto tumpukan sampah atau
                        pelanggaran kebersihan yang Anda
                        temui di lokasi.
            ...
            <div class="col-md-4">
                ...
                <div
                    ...
                    <p class="text-muted">
                        ...
                        Isi detail lokasi dan deskripsi singkat
                        agar petugas kami mudah menemukan
                        titik tersebut.
        ...
        <div class="container mb-4">
            ...
            <div class="text-center mb-5">
                ...
                <p class="text-muted mt-3">
                    ...
                    Mengenal jenis-jenis sampah adalah langkah
                    awal menuju pengelolaan lingkungan yang
                    lebih baik.
            ...
            <div class="card banner-card mb-5">
                ...
                <div
                    class="card-body bg-white text-center p-4">
                    ...
                    >
                        ...
                        Mari bersama-sama menjaga kebersihan
                        lingkungan dengan mengenali dan
                        melaporkan berbagai jenis sampah.

                        Pemilahan yang benar antara Sampah
                        Rumah Tangga, Pembuangan Liar, Sampah
                        Saluran Air, Sampah Pasar, hingga Limbah
                        B3 Ringan akan sangat membantu proses
                        daur ulang dan menjaga ekosistem Magetan.
                        ...
                        >
                            ...
                            >
                                ...
                                @if(!empty($berita->thumbnail))
                                    ...
                                    <img
                                        src="{{ asset('storage/' . ltrim($berita->thumbnail, '/')) }}"
                                        alt="{{ $berita->judul }}"
                                        class="berita-thumbnail mb-3"
                                        loading="lazy"
                                        onerror="
                                            this.onerror=null;
