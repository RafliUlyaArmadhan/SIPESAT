            ...
            <div class="card border-0 shadow-sm w-100" style="max-width: 480px; border-radius: 24px;">
                <div class="card-body p-4 p-sm-5">
                    ...
                    <div class="mb-4 text-center text-lg-start">
                        ...
                        <p class="text-muted">Email berhasil diverifikasi. Silakan masukkan password baru Anda.</p>
                    </div>
                    ...
                    <form action="{{ route('password.update') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input type="password" name="password" id="password" class="form-control form-control-lg bg-light border-0 @error('password') is-invalid @enderror" required placeholder="••••••••">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control form-control-lg bg-light border-0" required placeholder="••••••••">
                                <button class="btn bg-light border-0 text-muted px-3 toggle-password" type="button" data-target="#password_confirmation">
                                    <i class="fa-regular fa-eye-slash"></i>
                                </button>
                            </div>
                        </div>

                        <button type="submit" class="btn btn-primary w-100 py-3 mb-4 fw-bold shadow-sm" style="border-radius: 12px; font-size: 1.1rem;">Simpan Password Baru</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @if($errors->any())
            Swal.fire({
                ...
                text: 'Silahkan periksa inputan password Anda.',
                confirmButtonColor: '#3085d6',
            });
        @endif
    });
