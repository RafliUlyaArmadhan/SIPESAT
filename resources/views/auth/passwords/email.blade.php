...
<div class="container-fluid p-0">
    <div class="row g-0 min-vh-100">
        ...
        <div class="col-lg-6 bg-primary d-none d-lg-flex flex-column align-items-center justify-content-center p-5 text-white"
            ...
            <div class="card border-0 shadow-sm w-100"
                ...
                <div class="card-body p-4 p-sm-5">
                    ...
                    <div class="mb-4 text-center text-lg-start">
                        ...
                        <a href="{{ route('login') }}"
                           class="text-decoration-none text-muted mb-3 d-inline-block small fw-semibold">
                    ...
                    <!-- Form Email -->
                    <form action="{{ route('password.verify') }}"
                          method="POST">
                        ...
                        <button
                            type="submit"
                            class="btn btn-primary w-100 py-3 mb-4 fw-bold shadow-sm"
                            style="
                                border-radius: 12px;
                                font-size: 1.1rem;
                            ">
